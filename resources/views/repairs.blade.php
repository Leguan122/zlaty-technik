...
<section class="shell section" style="padding-top:18px">
    <div class="steps">
        <div class="step"><div class="step-num">01</div><strong>Popíšte problém</strong><span>Uveďte model zariadenia a čo presne sa deje.</span></div>
        <div class="step"><div class="step-num">02</div><strong>Diagnostika</strong><span>Najprv sa hľadá príčina, nie zoznam dielov na výmenu.</span></div>
